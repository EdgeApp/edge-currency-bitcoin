...
describe(`ServerCache`, function () {
  it('Score only', function () {
    ...
    const newServers = [
      'newServer1', 'newServer2', 'newServer3', 'server1', 'server2', 'server3', 'server4', 'server5'
    ]
  ...
  it('Bump score', function () {
    ...
    const newServers = [
      'server8', 'server2', 'server3', 'server4', 'server5', 'server6', 'server7'
    ]
  ...
  it('No old servers', function () {
    ...
    const newServers = [
      'newServer1', 'newServer2', 'newServer3'
    ]
